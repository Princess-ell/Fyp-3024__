...
$brandID = isset($_POST['brandID']) ? $_POST['brandID'] : 5;
...
<head>
    ...
    <title>Upload Simplysiti Product</title>
...
<header>
    <h1>Upload Simplysiti Product</h1>
</header>
...
<div class="container">
    ...
    <form action="simplysitiUpload.php" method="POST" enctype="multipart/form-data">
