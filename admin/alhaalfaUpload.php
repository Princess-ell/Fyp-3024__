...
$brandID = isset($_POST['brandID']) ? $_POST['brandID'] : 6;
...
<head>
    ...
    <title>Upload Alha AlfaProduct</title>
...
<header>
    <h1>Upload Alha Alfa Product</h1>
</header>
...
<div class="container">
    ...
    <form action="alhaalfaUpload.php" method="POST" enctype="multipart/form-data">
