...
$brandID = isset($_POST['brandID']) ? $_POST['brandID'] : 8;
...
<head>
    ...
    <title>Upload Silkygirl Product</title>
...
<header>
    <h1>Upload Silkygirl Product</h1>
</header>
...
<div class="container">
    ...
    <form action="bihanUpload.php" method="POST" enctype="multipart/form-data">
