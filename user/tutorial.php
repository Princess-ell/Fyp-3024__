...
<section class="tutorial-video">
    <h2>Latest Tutorial: Glam Makeup Look</h2>
    <div class="video-container">
        <!-- Embed the YouTube video -->
        <iframe src="https://www.youtube.com/embed/uHPKIBeAqUI" 
                frameborder="0" 
...
<section class="tutorials-list">
    ...
    <div class="tutorial-grid">
        <div class="tutorial-card">
            <a href="simplemakeup.php">
                <div class="tutorial-info">
                    <h3>How to Create a daily makeup Look</h3>
                    <p>Quick and easy steps for a natural, polished daily makeup look</p>
                </div>
            </a>
        </div>
        <div class="tutorial-card">
            <a href="glowinglook.php">
                <div class="tutorial-info">
                    <h3>Glowing look</h3>
                    <p>Achieve a radiant, dewy makeup look effortlessly.</p>
                </div>
            </a>
        </div>
        <div class="tutorial-card">
            <a href="graduationlook.php">
                <div class="tutorial-info">
                    <h3>Graduation Look</h3>
                    <p>Achieve a flawless, soft glam look that's perfect for celebrating your graduation in style.</p>
                </div>
            </a>
        </div>
    </div>
