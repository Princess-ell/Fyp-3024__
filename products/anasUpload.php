...
$brandID = isset($_POST['brandID']) ? $_POST['brandID'] : 7;
...
<head>
    ...
    <title>Upload Anas Product</title>
...
<div class="container">
    ...
    <form action="anasUpload.php" method="POST" enctype="multipart/form-data">
