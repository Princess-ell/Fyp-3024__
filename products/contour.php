...
$query = "SELECT * FROM products WHERE categoryID = 5"; //Blusheer
...
<head>
    ...
    <title>Cheek Products - Localuxe</title>
...
<!-- Sidebar -->
<div class="left-nav">
    <h3>Cheeks and Nose</h3>
    <ul>
        <li><a href="blusher.php">Blusher</a></li>
        <li><a href="contour.php">Contour</a></li>
        <li><a href="Highlighter.php">Highlighter</a></li>
    </ul>
    <h3>BRANDS</h3>
