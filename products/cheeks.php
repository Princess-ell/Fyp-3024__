...
<div class="left-nav">
    ...
    <!-- Brand Filter -->
    <h3>BRANDS</h3>
    <form method="GET" action="cheeks.php">
        <!-- Search Brand Input -->
    ...
    <div class="products-section">
        ...
        <div class="product-card">
            ...
            <p>GLOW RECIPE Blush - RM120.00</p>
        </div>

        <div class="product-card">
            <img src="bronzer.png" alt="Bronzer">
            <p>BRONZIER Glow - RM150.00</p>
        </div>

        <div class="product-card">
            <img src="highlighter.png" alt="Highlighter">
            <p>Shiny Highlighter - RM100.00</p>
        </div>
    </div>
</div>
