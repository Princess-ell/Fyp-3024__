...
$brandID = isset($_POST['brandID']) ? $_POST['brandID'] : 3;
...
<head>
    ...
    <title>Upload Cubremi Product</title>
...
<div class="container">
    ...
    <form action="cubremiUpload.php" method="POST" enctype="multipart/form-data">
